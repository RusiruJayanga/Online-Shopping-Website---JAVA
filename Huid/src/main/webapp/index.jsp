...
<html>
  ...
  <body>
        ...
        <div
          ...
          style="
            background-image: linear-gradient(
              ...
              url(images/8257e7bbd63b3ff.jpg); background-repeat: no-repeat;
          "
        >
          <div
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      ...
                      <p class="p1">
                        Get all the things you need in your daily life in
                        <br />one place...
                      </p>
                    </div>
                  </div>
    ...
    String str = "select * from add_item where cname = 'spe'";
    ...
    while(rs.next()){
    	   ...
    	   <div class="col-sm-6 col-md-4 col-lg-3">
    	          <div class="box">
    	            <div class="img-box">
    	              <img src="images/<%=rs.getString("ifile")%>" alt="" />
    	            </div>
    	            <div class="detail-box">
    	              <h6><%=rs.getString("iname")%></h6>
    	              <h6>
    	                Price:Rs
    	                <span><%=rs.getString("iprice")%></span>
    	              </h6>
    	            </div><a href="javascript:void(0);" onclick="addToCart('<%=rs.getString("item_id")%>', '<%=rs.getString("iname")%>', '<%=rs.getString("iprice")%>', '<%=rs.getString("ifile")%>')">
    	             <div class="new">
    	              <span>
    	               <i class="fa-sharp fa-solid fa-cart-shopping"></i><i class="fa-sharp fa-solid fa-plus"></i>
    	              </span>
    	            </div></a>
    	          </div>
    	        </div>
    	  ...
    	  <script>
    	      function addToCart(itemId, itemName, itemPrice, itemFile) {
    	          ...
    	          xhr.send("itemId=" + itemId + "&itemName=" + itemName + "&itemPrice=" + itemPrice + "&itemImage=" + itemFile);
    	      }
    	  </script>
<%}
        }catch (Exception e){
...
%>
      ...
      >
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-6">
              <div class="img-box">
                <img src="images/Gro.png" style="margin-top: 20%" alt="" />
              </div>
            </div>
            <div class="col-lg-6">
              <div class="detail-box">
                ...
                <p>
                  Fruits and vegetables are harvested daily at your fingertips.
                </p>
              </div>
            </div>
          </div>
    ...
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3309/mydb", "root", "");
    Statement at = conn.createStatement();
    String str = "select * from add_item where cname = 'vag'";
    ResultSet rs = at.executeQuery(str);
    while(rs.next()){
...
%>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="detail-box">
                ...
                <p>
                  Elevate your dishes with our premium spices.
                </p>
              </div>
            </div>
          </div>
   ...
   <section class="shop_section layout_padding">
    ...
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3309/mydb", "root", "");
    Statement at = conn.createStatement();
    String str = "select * from add_item where cname = 'spi'";
    ResultSet rs = at.executeQuery(str);
    while(rs.next()){
...
%>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="detail-box">
                ...
                <p>
                  Savor responsibly sourced meats from our farm to your table. 
                </p>
              </div>
            </div>
          </div>
    ...
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3309/mydb", "root", "");
    Statement at = conn.createStatement();
    String str = "select * from add_item where cname = 'ani'";
    ResultSet rs = at.executeQuery(str);
    while(rs.next()){
